...
| 3 Erster Kampf | 6–10 | Schattenratte (10 HP, greift für 3). Zug 1: Hand = 3 Angriffe. Zug 2: Absicht-Highlight + Holzschild. Zug 3+: frei. Sieg → sofort Level 2 | Karte spielen, Energie, Block vs. Absicht |
...
- Kampf 1 „Schattenratte": seed fix; Zug-1-Hand = [Axtschlag, Axtschlag, Steinwurf];
  Zug-2-Hand enthält garantiert Holzschild; Gegnerzyklus [attack3, attack3, ...]
